...
function InitiativeTile() {
    ...
    return (
        <label for="my-modal-4">
            <div className="min-h-16 bg-white flex flex-row items-center rounded-xl overflow-clip space-x-4">
